...
- (NSString *)responseString
{
    ...
    NSString *respString = [NSString stringWithCString:[data bytes] encoding:[self responseEncoding]] ;
    respString = [respString stringByReplacingOccurrencesOfString:@"&gt;" withString:@">"];
    respString = [respString stringByReplacingOccurrencesOfString:@"&lt;" withString:@"<"];
