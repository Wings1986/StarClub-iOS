...
@interface FanFeedImageCell : UITableViewCell
...
@property (strong, nonatomic) IBOutlet UIImageView *imgLockIcon;
@property (strong, nonatomic) IBOutlet UIImageView *imgPremium;
